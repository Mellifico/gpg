...
<div id="grid-isotope-seals" class="row align-left align-top">
<?php
...
?>
<article class="stamp small-12 medium-6 large-6 callout text-center">
...
<img class="thumbnail" src="<?php echo seal_cover_src_medium(); ?>" alt="<?php the_title(); ?>" data-interchange="[<?php echo seal_cover_src_thumbnail(); ?>, small], [<?php echo seal_cover_src_medium(); ?>, medium], [<?php echo seal_cover_src_medium(); ?>, large]">
</article>
<?php endwhile; ?>
...
<article class="seal small-6 medium-3 large-3 callout text-center">

<h4><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?> » <?php the_field('tagline'); ?>"><?php the_title(); ?></a></h4>
<p><em><?php the_field('tagline'); ?></em></p>
<img class="thumbnail" src="<?php echo seal_cover_src_medium(); ?>" alt="<?php the_title(); ?>" data-interchange="[<?php echo seal_cover_src_thumbnail(); ?>, small], [<?php echo seal_cover_src_thumbnail(); ?>, medium], [<?php echo seal_cover_src_medium(); ?>, large]">
</article>
		<?php endwhile; ?>
