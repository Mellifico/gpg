...
<p class="big gpg-slide-3"><?php echo __('Selected by', 'FoundationPress'); ?> <a href="https://parisiangentleman.fr/" target="_blank" title="parisiangentleman.fr"><span data-tooltip aria-haspopup="true" class="has-tip" data-disable-hover="false" tabindex="1" title="<?php echo __('Parisian Gentleman is an online magazine dedicated to classical men’s style', 'FoundationPress'); ?>"><em>Parisian Gentleman</em></span></a></p>
</div>
...
?>
<article class="column small-12 medium-6 large-6 CoverImage mid-height" style="position:relative;background-image:url(<?php echo seal_cover_src_medium(); ?>);">
<div class="seal-card full-block">
<div class="on-top full-block">
<h2 class="full-block"><a class="block full-block boxshadow" style="padding:1rem;" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?> » <?php the_field('tagline'); ?>"><?php echo __('Featuring:', 'FoundationPress'); ?> <?php the_title(); ?></a></h2>
</div>
</div>              
<?php endwhile; ?>
</article>
...
<article class="column small-6 medium-3 large-3 mid-height CoverImage" style="position:relative;background-image:url(<?php echo seal_cover_src_bigsquare(); ?>);">
<div class="seal-card full-block">
<div class="on-top full-block">
<h2 class="full-block"><a class="block full-block boxshadow" style="padding:1rem;" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?> » <?php the_field('tagline'); ?>"><?php the_title(); ?></a></h2>
</div>
</div>
</article>
		<?php endwhile; ?>
